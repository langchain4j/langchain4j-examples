...
class RagWithAstraAndOpenAiTest {

    final String db = "langchain4j";
    final String vectorStore = "happy_carrot_open_ai";
    final String embeddingsModel = "text-embedding-ada-002";
    final String completionModel = "gpt-3.5-turbo";
    final int vectorDimension = 1536;
    ...
    void shouldRagWithOpenAiAndAstra() {
        // Initialization
        String databaseId = setupVectorDatabase(db, db);
        ...
        DocumentSplitter splitter = DocumentSplitters
                .recursive(100, 10, new OpenAiTokenizer(completionModel));
