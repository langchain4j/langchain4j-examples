...
- [In-process, offline image search with CLIP](https://github.com/langchain4j/langchain4j-examples/tree/main/onnx-image-embedding-example) - image-to-image and text-to-image search against an image store, entirely inside the JVM with ONNX
