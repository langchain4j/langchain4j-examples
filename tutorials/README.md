...
```shell
java -cp ./target/tutorials-0.35.0-jar-with-dependencies.jar _00_HelloWorld "what is Java?"
```
...
```shell
native-image -cp ./target/tutorials-0.35.0-jar-with-dependencies.jar _00_HelloWorld -o native-helloworld
