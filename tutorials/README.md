...
```shell
java -cp ./target/tutorials-1.0.1-beta6-jar-with-dependencies.jar _00_HelloWorld "what is Java?"
```
...
```shell
native-image -cp ./target/tutorials-1.0.1-beta6-jar-with-dependencies.jar _00_HelloWorld -o native-helloworld
