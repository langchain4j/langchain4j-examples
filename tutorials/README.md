...
```shell
java -cp ./target/tutorials-1.6.0-beta12-jar-with-dependencies.jar _00_HelloWorld "what is Java?"
```
...
```shell
native-image -cp ./target/tutorials-1.6.0-beta12-jar-with-dependencies.jar _00_HelloWorld -o native-helloworld
