...
import dev.langchain4j.mcp.client.transport.stdin.StdioMcpTransport;
...
public class McpToolsExampleOverStdio {
    ...
    public static final String FILE_TO_BE_READ = "mcp-example/src/main/resources/file.txt";
     ...
     * equal to the root directory of the repository
     * (`langchain4j-examples`), otherwise the program won't be able to find
     * the proper file to read.
     */
    public static void main(String[] args) throws Exception {
        ...
        McpTransport transport = new StdioMcpTransport.Builder()
                .command(List.of("/usr/bin/npm", "exec",
                        ...
                        new File("mcp-example/src/main/resources").getAbsolutePath()
                        ))
                .logEvents(true)
                .build();
