...
public class VespaEmbeddingStoreExample {
  ...
  public static void main(String[] args) {
    EmbeddingStore<TextSegment> embeddingStore = VespaEmbeddingStore
      ...
      //      .keyPath("keyPath")
      .keyPath(
        "/Users/alexey.titov/.vespa/alexey-heezer.langchain4j.mytenant346/data-plane-private-key.pem"
      )
      ...
      //      .certPath("certPath")
      .certPath(
        "/Users/alexey.titov/.vespa/alexey-heezer.langchain4j.mytenant346/data-plane-public-cert.pem"
      )
      .build();
